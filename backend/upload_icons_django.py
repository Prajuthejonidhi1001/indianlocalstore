...
subcat_mappings = {
    ...
    # Electronics
    "Accessories": "electronic accesories.png", # electronic assc.png
    ...
    # Event Management
    "Birthday Decoration": "Birthday decoration.png", # or birthday decoration.jpeg
    "Corporate Event": "corporate events.jpeg", # or corporate event.jpeg
    "Stage Decoration": "stage decoration.png",
    "Wedding Service": "weddind service.png",
    
    # Fashion
    "Artificial Jewels": "artificial jewel.jpeg", # or artificial jewels.jpeg
    ...
    # Pharmacy
    "Baby Cares": "Baby_Cares.png", # baby care product.png
    "Fitness Supplement": "fitness supplement.png", # fitness suppliment.png
...
for cat in Category.objects.all():
    ...
    for sub in cat.subcategories.all():
        ...
        if path and os.path.exists(path):
            ...
            print(f"File not found for {sub.name} in {cat.name}")
